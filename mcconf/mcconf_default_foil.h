...
#define MCCONF_S_PID_KP					0.00039	// Proportional gain
#endif
#ifndef MCCONF_S_PID_KI
#define MCCONF_S_PID_KI					0.00120	// Integral gain
#endif
...
#define MCCONF_S_PID_RAMP_ERPMS_S		100000	// Default Speed Input Ramp
#endif
...
#define AWCONF_FW_CURRENT_MAX		    0.0 // Maximum field weakening current
#endif
...
#define AWCONF_FW_RAMP_TIME             2.0 // Ramp time for field weakening current in seconds
#endif
#ifndef AWCONF_FW_Q_CURRENT_FACTOR
#define AWCONF_FW_Q_CURRENT_FACTOR	    0.02 // Factor of the FW-current to feed to the Q-axis to slow motor down when setting 0 current
#endif
