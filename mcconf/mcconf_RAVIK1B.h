...
// FOC
#define MCCONF_FOC_CURRENT_KP			0.0368
#define MCCONF_FOC_CURRENT_KI			37.5
#define MCCONF_FOC_MOTOR_L				3.676e-05
#define MCCONF_FOC_MOTOR_R				0.03745
#define MCCONF_FOC_MOTOR_FLUX_LINKAGE	0.019920
#define MCCONF_FOC_MOTOR_LD_LQ_DIFF		0.0
#define MCCONF_FOC_OBSERVER_GAIN		2.52e6		// Can be something like 600 / L
